...
function LoginForm() {
  ...
  return (
    <div style={{ minHeight: '100vh', background: C.bg, display: 'flex', alignItems: 'center', justifyContent: 'center', padding: 20, fontFamily: C.fi, position: 'relative', overflow: 'hidden' }}>
      {/* Dot grid */}
      ...
      {/* Top glow */}
      <div style={{ position: 'absolute', top: '-15%', left: '50%', transform: 'translateX(-50%)', width: 700, height: 400, background: 'radial-gradient(ellipse, rgba(255,255,255,0.025) 0%, transparent 65%)', pointerEvents: 'none' }} />
