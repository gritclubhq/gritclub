      ...
      <div className="p-6 max-w-lg mx-auto">
        ...
        <form onSubmit={handleSubmit}>
          <div className="rounded-2xl p-5 space-y-4 mb-4" style={{ background: '#1E293B' }}>
              ...
              <div className="flex flex-wrap gap-2">
                {CATEGORIES.map(c => (
                  <button key={c} type="button" onClick={() => setForm({ ...form, category: c })}
                    ...
                    style={{
                      background: form.category === c ? '#38BDF8' : '#0F172A',
                      color: form.category === c ? '#0F172A' : '#94A3B8',
            ...
            <div className="flex items-center justify-between p-3 rounded-xl" style={{ background: '#0F172A' }}>
              <div>
